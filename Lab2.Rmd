...
#### I would choose to go with the default of 30 bins to get an accurate sense of the distribution. Values closer to 10 bins seems like too few to get a sense of the distribution while 100 bins seems like too many (with only about 2 entries per bin).
